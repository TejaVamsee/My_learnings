...
int main() {
    int* p = malloc(10);
    p = realloc(p, 1000000000); // if fails, due to large size and lose access to malloc pointer
...
## Output
<img width="896" height="620" alt="image" src="https://github.com/user-attachments/assets/dcb19bbf-af5d-41d4-b7a5-5ee0d7d2bec4" />
...
<img width="896" height="531" alt="image" src="https://github.com/user-attachments/assets/28110ec9-c4a8-4d6f-9d95-244cc98b4d04" />
